/*
Script: 005_AG Dashboard.sql
Author: Ziad Alashram

Purpose:
Generates a detailed dashboard of Availability Group health metrics.

Usage:
- Execute on SQL Instances (Group 1) only.
- Optional: Set @AGname to target a specific AG.

Output:
- Replica roles, synchronization state, failover readiness, estimated data loss and recovery time.
*/
